                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer">
                            ...
                            <form action=" " method="post">
                                <input type="hidden" name="user_id" value=" ID_DO_USUARIO">
                                        @csrf
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 main-color">
            ...
            <a href="/" class="brand-link">
                <img src=" " alt="JT Squad" class=""
                    style="opacity: .8">
                <span
                    class="brand-text font-weight-light">{{ $setting->company ?? env('APP_NAME') }}</span>
            </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href=" " class="nav-link ">
                                <!-- class="nav-link isActive('dashboard.administrator.reports') " -->
